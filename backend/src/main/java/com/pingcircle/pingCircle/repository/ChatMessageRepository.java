...
public interface ChatMessageRepository extends JpaRepository<ChatMessage, Long> {
    ...
    // Finds all messages sent or received by a specific user
    // This query retrieves all messages where the user is either the sender or receiver.
    ...
    // Finds all contacts of a user based on sent and received messages
    // This query retrieves distinct usernames that have interacted with the specified user.
